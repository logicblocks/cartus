...
(deftest match-candidates-generates-all-candidates-when-n-equals-length
  ...
  (is (= [[1 2]
          [::m/missing 1] [1 ::m/missing]
          [::m/missing 2] [2 ::m/missing]
          [::m/missing ::m/missing]]
        (m/match-candidates [1 2] 2)))
  (is (= [[1 2 3]
          [::m/missing 1 2] [1 ::m/missing 2] [1 2 ::m/missing]
          [::m/missing 1 3] [1 ::m/missing 3] [1 3 ::m/missing]
          [::m/missing 2 3] [2 ::m/missing 3] [2 3 ::m/missing]
          [::m/missing ::m/missing 1]
          [::m/missing 1 ::m/missing]
          [1 ::m/missing ::m/missing]
          [::m/missing ::m/missing 2]
          [::m/missing 2 ::m/missing]
          [2 ::m/missing ::m/missing]
          [::m/missing ::m/missing 3]
          [::m/missing 3 ::m/missing]
          [3 ::m/missing ::m/missing]
  ...
  (is (= [[1 1 1]
          [::m/missing 1 1] [1 ::m/missing 1] [1 1 ::m/missing]
          [::m/missing ::m/missing 1]
          [::m/missing 1 ::m/missing]
          [1 ::m/missing ::m/missing]
          [::m/missing ::m/missing ::m/missing]]
...
(deftest match-candidates-generates-candidates-when-n-less-than-length
  ...
  (is (= [[1 2] [1 3] [1 4] [2 3] [2 4] [3 4]
          [::m/missing 1] [1 ::m/missing]
          [::m/missing 2] [2 ::m/missing]
          [::m/missing 3] [3 ::m/missing]
          [::m/missing 4] [4 ::m/missing]
          [::m/missing ::m/missing]]
        (m/match-candidates [1 2 3 4] 2)))
  (is (= [[1 2 3] [1 2 4] [1 3 4] [2 3 4]
          [::m/missing 1 2] [1 ::m/missing 2] [1 2 ::m/missing]
          [::m/missing 1 3] [1 ::m/missing 3] [1 3 ::m/missing]
          [::m/missing 1 4] [1 ::m/missing 4] [1 4 ::m/missing]
          [::m/missing 2 3] [2 ::m/missing 3] [2 3 ::m/missing]
          [::m/missing 2 4] [2 ::m/missing 4] [2 4 ::m/missing]
          [::m/missing 3 4] [3 ::m/missing 4] [3 4 ::m/missing]
          [::m/missing ::m/missing 1]
          [::m/missing 1 ::m/missing]
          [1 ::m/missing ::m/missing]
          [::m/missing ::m/missing 2]
          ...
          [::m/missing 3 ::m/missing]
          [3 ::m/missing ::m/missing]
          [::m/missing ::m/missing 4]
          [::m/missing 4 ::m/missing]
          [4 ::m/missing ::m/missing]
          [::m/missing ::m/missing ::m/missing]]
