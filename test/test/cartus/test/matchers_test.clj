...
(deftest match-candidates-generates-all-candidates-when-n-equals-length
  ...
  (is (= [[1 2 3]
          [::mc-core/missing 1 2] [1 ::mc-core/missing 2] [1 2 ::mc-core/missing]
          [::mc-core/missing 1 3] [1 ::mc-core/missing 3] [1 3 ::mc-core/missing]
          [::mc-core/missing 2 3] [2 ::mc-core/missing 3] [2 3 ::mc-core/missing]
  ...
  (is (= [[1 1 1]
          [::mc-core/missing 1 1] [1 ::mc-core/missing 1] [1 1 ::mc-core/missing]
          [::mc-core/missing ::mc-core/missing 1]
          [::mc-core/missing 1 ::mc-core/missing]
          [1 ::mc-core/missing ::mc-core/missing]
          [::mc-core/missing ::mc-core/missing ::mc-core/missing]]
...
(deftest match-candidates-generates-candidates-when-n-less-than-length
  ...
  (is (= [[1 2 3] [1 2 4] [1 3 4] [2 3 4]
          [::mc-core/missing 1 2] [1 ::mc-core/missing 2] [1 2 ::mc-core/missing]
          [::mc-core/missing 1 3] [1 ::mc-core/missing 3] [1 3 ::mc-core/missing]
          [::mc-core/missing 1 4] [1 ::mc-core/missing 4] [1 4 ::mc-core/missing]
          [::mc-core/missing 2 3] [2 ::mc-core/missing 3] [2 3 ::mc-core/missing]
          [::mc-core/missing 2 4] [2 ::mc-core/missing 4] [2 4 ::mc-core/missing]
          [::mc-core/missing 3 4] [3 ::mc-core/missing 4] [3 4 ::mc-core/missing]
          [::mc-core/missing ::mc-core/missing 1]
          [::mc-core/missing 1 ::mc-core/missing]
          [1 ::mc-core/missing ::mc-core/missing]
          [::mc-core/missing ::mc-core/missing 2]
